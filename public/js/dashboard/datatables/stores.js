        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/stores?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `
                        <a class="d-block overlay" data-fslightbox="lightbox-basic" href="${getImagePath(data, 'Stores')}">
                            <!--begin::Image-->
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                    style="height:56px;width:100px;border-radius:4px;margin:auto;background-image:url('${getImagePath(data, 'Stores')}');background-size:contain;">
                            </div>
                            <!--end::Image-->
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/stores/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/stores/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
