            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        return `
                        <a class="d-block overlay" data-fslightbox="lightbox-basic" href="${getImagePath(data, 'Admins')}">
                            <!--begin::Image-->
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                    style="height:56px;width:100px;border-radius:4px;margin:auto;background-image:url('${getImagePath(data, 'Admins')}');background-size:contain;">
                            </div>
                            <!--end::Image-->
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/admins/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
