        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/orders?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
                ...
                {data: 'region.name'},
                {data: 'sale_price'},
                {data: 'shipping_status.name'},
                {data: 'preparation_date', name:'preparation_date'},
                {data: 'status_name', name:'status'},
                {data: 'social_employee.name', name:'created_by'},
                {data: 'warehouse_employee.name', name:'prepared_by'},
                {data: 'contact_employee.name', name:'client_contacted_by'},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if(isSocialMedia && row.status == createdStatus)
                            editBtn = `<!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/orders/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
