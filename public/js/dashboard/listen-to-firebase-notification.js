...
function onPushing() {
    messaging.onMessage(function(payload) {
        ...
        $("#mark_all_as_read_btn").removeClass('d-none');
        ...
        <div class="d-flex flex-stack py-4 notification-item">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-50px me-4">
                    <span class="symbol-label bg-light-primary">
                        <span class="svg-icon svg-icon-2x svg-icon-primary">
                            <svg fill="#086397" height="24" width="24" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="0 0 611.999 611.999" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                ...
                <!--begin::Title-->
                <div class="mb-0 me-2">
                    <a href="/notifications/${data['gcm.notification.id']}/mark_as_read" class="fs-6 text-gray-800 text-hover-primary fw-bold">${data['gcm.notification.alert_title']}</a>
...
$("#unread-load-more,#all-load-more").click(function (e) {
    ...
    $.ajax({
        type: 'get',
        url: `/notifications/${type}/load-more/${currentNotificationsCount}`,
        success: function (res) {
            if(res.data.length == 0){
                    ...
                    loadMoreBtn.before(`
                        <div class="d-flex flex-stack py-4 notification-item">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="mb-0 me-2">
                                    <a href="/notifications/${notification.id}/mark_as_read" class="fs-6 text-gray-800 text-hover-primary fw-bold">${notification.title}</a>
                ...
                res.isMoreExist ? loadMoreBtn.attr('data-kt-indicator', 'off') : loadMoreBtn.remove();
            }
