...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.orders.index') }}" class="text-muted text-hover-primary">{{ __("Orders") }}</a></h1>
                <!-- end :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.orders.store') }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.orders.index') }}">
            @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Add new order") }}</h3>
                </div>
                <!-- end :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="client_name_inp" name="client_name" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input required dir="ltr" type="text" class="form-control" id="client_mobile_inp" name="client_mobile" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" min="1" class="form-control" id="discount_inp" name="discount" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input required type="text" class="form-control datepicker" id="preparation_date_inp" name="preparation_date" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <textarea id="client_notes_inp" name="client_notes" rows="3" class="form-control" placeholder="{{ __('Enter client notes') }}"></textarea>
