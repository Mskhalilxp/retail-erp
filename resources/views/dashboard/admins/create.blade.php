    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.admins.index') }}" class="text-muted text-hover-primary">{{ __("Admins") }}</a></h1>
                <!-- end   :: Title -->
            ...
            @csrf
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row d-flex flex-column align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <label class="text-center fw-bold mb-4">{{ __("Photo") }}</label>
                                <x-dashboard.upload-image-inp name="photo" :image="null" :directory="null" placeholder="default.svg" type="editable" ></x-dashboard.upload-image-inp>
                                <!-- end   :: Upload image component -->
                            </div>
                            <p class="invalid-feedback text-center" id="photo" ></p>
                    ...
                    <div class="row mb-8">
                        ...
                        <!-- begin :: Column -->
                        <div class="col-md-4 fv-row">
                            <label class="required fs-5 fw-bold mb-2">{{ __("Phone") }}</label>
                            <div class="form-floating">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="email_inp" name="email" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        <!-- begin :: Column -->
                        <div class="col-md-4 fv-row">
                            <label class="required fs-5 fw-bold mb-2">{{ __("Role") }}</label>
                            <select required class="form-select" data-control="select2" name="role" id="role_inp" data-placeholder="{{ __("Select role") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" >
                                <option value=""></option>
                                @foreach (App\Enums\EmployeeRole::values() as $value => $name)
                                    <option value="{{ $value }}">{{ __(ucfirst(str_replace('_', ' ', $name))) }}</option>
                                @endforeach
                            </select>
                            <p class="invalid-feedback" id="role" ></p>
                        </div>
                        <!-- end :: Column -->
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="password" class="form-control" id="password_confirmation_inp" name="password_confirmation" placeholder="example"/>
