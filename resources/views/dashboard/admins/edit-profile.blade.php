                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <h2 class="text-gray-900 fs-2 fw-bolder me-1">{{ auth('admin')->user()->name }}</h2>
                            </div>
                            <!--end::Name-->
                        </div>
                        <!--end::User-->
            ...
            <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <form action="{{ route('dashboard.update-profile') }}" class="submitted-form" method="post" data-redirection-url="{{ route('dashboard.index') }}" data-success-message="{{ __('Profile has been updated successfully') }}">
                    ...
                    <div class="card-body  p-9">
                        ...
                        <!--begin::Input group-->
                        <div class="row mb-15">
                            <label class="required col-lg-2 required fs-5 fw-bold mb-2 d-flex align-items-center">{{ __("Photo") }}</label>

                            <div class="col-lg-10 form-floating text-center">

                                <!--begin::Image input-->
                                <x-dashboard.upload-image-inp name="photo" :image="auth('admin')->user()->photo" directory="Admins" placeholder="default.svg" type="editable"></x-dashboard.upload-image-inp>
                                <p class="invalid-feedback" id="photo"></p>
                                <!--end::Image input-->
                        ...
                        <!--begin::Input group-->
                        <div class="row mb-6">
                            <label class="required col-lg-2 required fs-5 fw-bold mb-2 d-flex align-items-center">{{ __("Name") }}</label>

                            <div class="col-lg-10 form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name"  placeholder="example" value="{{ auth('admin')->user()->name }}"/>
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="required col-lg-2 col-form-label required fw-bold fs-6 d-flex align-items-center">{{ __("Phone") }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                                <div class="col-lg-10 form-floating">
                                    <input type="text" class="form-control" id="phone_inp" name="phone" placeholder="example" value="{{ auth('admin')->user()->phone }}"/>
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="required col-lg-2 col-form-label required fw-bold fs-6 d-flex align-items-center">{{ __("Email") }}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                                <div class="col-lg-10 form-floating">
                                    <input type="text" class="form-control" id="email_inp" name="email" placeholder="example" value="{{ auth('admin')->user()->email }}"/>
