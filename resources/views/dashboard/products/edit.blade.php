...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.products.update',$product->id) }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.products.index') }}">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Edit product data") . " : " . $product->name  }}</h3>
                </div>
                <!-- end :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row d-flex flex-column align-items-center">
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$product->image" directory="Products/{{ $product->store_id }}" placeholder="default.svg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input required type="text" class="form-control" id="name_inp" name="name" value="{{ $product->name }}" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input required type="number" min="1" class="form-control" id="quantity_inp" name="quantity" value="{{ $product->quantity }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input required type="number" min="1" class="form-control" id="actual_price_inp" name="actual_price" value="{{ $product->actual_price }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input required type="number" min="1" class="form-control" id="sale_price_inp" name="sale_price" value="{{ $product->sale_price }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea id="details_inp" name="details" rows="5" class="form-control" placeholder="{{ __('Enter the details') }}">{{ $product->details }}</textarea>
