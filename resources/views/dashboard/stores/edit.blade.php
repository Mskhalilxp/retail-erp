...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.stores.update',$store->id) }}" class="form submitted-form" method="post"  data-redirection-url="{{ route('dashboard.stores.index') }}">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Edit store data") . " : " . $store->name  }}</h3>
                </div>
                <!-- end :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row d-flex flex-column align-items-center">
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="logo" :image="$store->logo" directory="Stores" placeholder="default.svg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name" value="{{ $store->name }}" placeholder="example"/>
