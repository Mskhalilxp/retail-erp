    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="px-4 text-muted fs-6 fw-bold my-1 ms-1">
                            {{ __("Hello") }} , {{ auth('admin')->user()->name }}
                        </div>
                    </div>
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Menu toggle-->
                    <a href="#" class="topbar-item px-3" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu" style="">
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                                ...
                                <span class="menu-title">{{ __('System mode') }}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                ...
                {{-- <div class="d-flex align-items-center mx-3">
                    ...
                    <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary w-40px h-40px position-relative" data-kt-menu-trigger="{default: 'click', lg: 'click'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" id="kt_menu" data-kt-menu="true" style="">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('dashboard-assets/media/misc/menu-header-bg.jpg') }}')">
                            <div class="d-flex justify-content-between align-items-center">
                                <!--begin::Title-->
                                <h3 class="text-white fw-semibold px-5 mt-10 mb-6">{{ __('Notifications') }}
                                    @if ($unreadNotifications->count() > 0)
                                        <span class="fs-8 opacity-75 ps-3 notifications-counter">{{$unreadNotifications->count() .  __(' unread') }}</span>
                                    @else
                                        <span class="fs-8 opacity-75 ps-3 notifications-counter"> {{ __('No notifications') }}</span>
                                    @endif
                                </h3>
                                <!--end::Title-->
                                <a href="{{ route('dashboard.notifications.mark_all_as_read') }}" id="mark_all_as_read_btn" class="text-white fw-semibold px-5 mt-10 mb-6 {{ $unreadNotifications->count() == 0 ? 'd-none' : '' }}">{{ __('Mark all as read') }}</a>
                            </div>
                                    ...
                                    @forelse ($allNotifications->take(10)->get() as $notification)
                                        ...
                                        <div class="d-flex flex-stack py-4 notification-item">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a href="{{route('dashboard.notifications.mark_as_read', $notification->id)}}" class="fs-6 text-gray-800 text-hover-primary fw-bold">{{$notification->data['title']}}</a>
                                    ...
                                    @empty
                                        <div class="d-flex flex-column px-9 pb-5 no-notifications-alert">
                                            ...
                                            <div class="text-center px-4">
                                                <img class="mw-100 mh-200px" alt="image" src="{{ asset('dashboard-assets/media/illustrations/sigma-1/8-dark.png') }}">
                                            </div>
                                            <!--end::Illustration-->
                                            <!--begin::Section-->
                                            <div class="pt-10 pb-0">
                                                <!--begin::Title-->
                                                <h3 class="text-dark text-center fw-bold">{{ __('No notifications') }}</h3>
                                                <!--end::Title-->
                                                <!--begin::Text-->
                                                <div class="text-center text-gray-600 fw-semibold pt-1">{{ __("You'll see your notifications here once they come") }}</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Section-->
                                        </div>
                ...
                <!--begin::User menu-->
                <div class="d-flex align-items-center mx-3" id="kt_header_user_menu_toggle">
                    <!--begin::Menu wrapper-->
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px rounded" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ auth('admin')->user()->photo ? getImagePath(auth('admin')->user()->photo) : asset('placeholder_images/avatar.jpg') }}" alt="user" class="rounded-1" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ auth('admin')->user()->photo ? getImagePath(auth('admin')->user()->photo) : asset('placeholder_images/avatar.jpg') }}" class="rounded-1"/>
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5"> {{ auth('admin')->user()->name }}</div>
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('change-language','ar') }}" class="menu-link d-flex px-5 @if( isArabic() == 'ar' ) active @endif">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('change-language','en') }}" class="menu-link d-flex px-5 @if( ! isArabic() ) active @endif">
                                            <span class="symbol symbol-20px me-4">
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('dashboard.edit-profile') }}" class="menu-link px-5">{{__("Account Settings")}}</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
