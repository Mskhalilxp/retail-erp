        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <!-- begin :: settings section -->
                    ...
                    @if (isSuperAdmin())
                        <div class="menu-item">
                            <a class="menu-link {{ isTabActive('') }}" href="{{ route('dashboard.index') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                                    <i class="fas fas fa-chart-column"></i>
                            </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ isTabActive('stores') }}" href="{{ route('dashboard.stores.index') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ isTabActive('stocks') }}" href="{{ route('dashboard.stocks.index') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
                                <i class="fas fa-cubes"></i>
                            </span>
                            <span class="menu-title"> {{ __("Stocks") }}</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link {{ isTabActive('campaigns') }}" href="{{ route('dashboard.campaigns.index') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon">
